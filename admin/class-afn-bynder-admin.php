...
class Afn_Bynder_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/dist/afn-bynder-admin.min.js', array( 'jquery' ), $this->version, false );
